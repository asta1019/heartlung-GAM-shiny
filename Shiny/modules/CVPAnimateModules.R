  ...
  moduleServer(id, function(input, output, session) {
    ...
    gam_anim <- eventReactive(input$generate_gam_animation, {
      ...
      # -------------------------------
        ...
        p_A <- ggplot(structured_data, aes(P_wave_rel_index, CVP)) +
          geom_line(alpha = 0.2) +
          labs(
          ...
          ggtitle(
            ...
            subtitle = "The CVP waveform for a heart beat and how it depends on/changes with the\nrespiratory cycle"
          ) +
        ...
        # Animation B: Effect of respiration on average CVP level
